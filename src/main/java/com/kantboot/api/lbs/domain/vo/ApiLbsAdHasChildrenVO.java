...
public class ApiLbsAdHasChildrenVO {
     ...
     */
    @OneToMany
    @JoinColumn(name = "parent_adcode", referencedColumnName = "adcode", insertable = false, updatable = false)
    private List<ApiLbsAdHasChildrenVO> children;
